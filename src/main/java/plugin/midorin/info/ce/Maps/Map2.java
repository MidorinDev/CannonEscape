...
public class Map2
{
    ...
    public static void firstTp(Player player)
    {
        ...
        {
            player.teleport(new Location(player.getWorld(), 1072, 45, 260));
            ...
            player.teleport(new Location(player.getWorld(),1111, 37, 260));
    ...
    public static void resetMap(Player player)
    {
        ...
        File schematic = new File("plugins/WorldEdit/schematics/Map2.schematic");
        ...
        try
        {
            MCEditSchematicFormat.getFormat(schematic).load(schematic).paste(session, new Vector(1070,46,260), false);
        }
